...
contract AMM2 is ReentrancyGuard {
    ...
    // Different fee than AMM1 (0.5% instead of 0.3%)
    uint256 public constant FEE_MULTIPLIER = 995; 
    ...
    function getAmountOut(uint256 amountIn, uint256 reserveIn, uint256 reserveOut) public pure returns (uint256) {
        ...
        uint256 amountInWithFee = amountIn * FEE_MULTIPLIER; // 0.5% fee
